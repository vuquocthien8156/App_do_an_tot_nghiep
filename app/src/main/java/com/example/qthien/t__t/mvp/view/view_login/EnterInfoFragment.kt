...
class EnterInfoFragment : Fragment() , ILogin {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        customer = Customer(0, "", "", null, 0, 0, "", "", "", null, "")
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.btnContinuteInfo.setOnClickListener({
            if(checkValidate()){
                ...
                callActivity?.setBackPress(false)
                callActivityPhone?.setBackPress(false)
    ...
    override fun resultRegisterAccount(idUser: Int?) {
        ...
        if(idUser == null) {
            ...
            callActivity?.setBackPress(true)
            callActivityPhone?.setBackPress(true)
        }
        else {
            if (customer != null) {
