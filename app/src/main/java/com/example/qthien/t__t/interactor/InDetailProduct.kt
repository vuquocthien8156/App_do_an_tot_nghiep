...
import com.example.qthien.t__t.presenter.detail_product.IPreDetailProduct
...
class InDetailProduct(var iPreDetailProduct: IPreDetailProduct) {
    ...
    fun callDetailOrEvaluation(idProduct : Int, idUser : Int , page : Int? , point : Int? , time : Int?){
        val call = instance.getDetailOrEvaluationForProduct(idProduct , idUser , page , point , time)
