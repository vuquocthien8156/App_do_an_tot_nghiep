...
import com.example.qthien.t__t.mvp.presenter.pre_search_product.PreSearchProductActivity
...
class SearchProductActivity : AppCompatActivity() , IViewSearchProductActivity {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = SearchProductAdapter(this , ALPHABETICAL_COMPARATOR , discount)
